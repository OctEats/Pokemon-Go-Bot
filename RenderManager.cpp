...
void Render::Initialise()
{
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::TabIcon, "Untitled1", 45, 500, 0, 0, FONTFLAG_ANTIALIAS);
}
...
void Render::GradientHDarker(int x, int y, int w, int h, Color c1, Color c2)
{
	Clear(x, y, w, h, c1);
	BYTE first = c2.r();
	BYTE second = c2.g();
