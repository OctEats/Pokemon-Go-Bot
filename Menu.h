...
class CExtraTab3 : public CTab
{
public:
	void Setup();
};

class CExtraTab4 : public CTab
{
public:
	void Setup();
};

class CExtraTab5 : public CTab
{
public:
	void Setup();
};

class CExtraTab6 : public CTab
{
public:
	void Setup();
};
...
public:
	...
	CMiscTab MiscTab;
	CExtraTab ExtraTab;
	CExtraTab2 ExtraTab2;
	CExtraTab3 ExtraTab3;
	CExtraTab4 ExtraTab4;
	CExtraTab5 ExtraTab5;
	CExtraTab6 ExtraTab6;
	CButton SaveButton;
	CButton LoadButton;
